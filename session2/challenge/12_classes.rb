...
class Fraction
  ...
  def to_f
    ...
    #returns ratio to a float 0.5
  end

  def lowest
      #returns a new Fraction, where the numerator and denominator are reduced to lowest terms (ie 20/60 becomes 1/3)
  ...
  def to_s
    ...
    #represents the Fraction as a String "50/100"
  end
end
